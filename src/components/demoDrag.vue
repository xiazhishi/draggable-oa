<template>
  <div class="demo-drag">
    ...
    <el-row>
      <el-col style="width: 319px;border-right: 1px solid #ccc;padding-right: 5px;">
        <main-sidebar @setSecondRatio="setSecondRatio" @clear="clear" />
      </el-col>
      <el-col
          style="height:calc(100vh - 71px); width: calc(100% - 232px);overflow-y: auto;"
          id="form-center"
      >
...
<!--            >保存</el-button>-->
<!--            <control-content-->
<!--                v-if="$store.state.formDesign.grid"-->
<!--                :propData="$store.state.formDesign.grid" @change-cell="changeCell"></control-content>-->
<!--          </div>-->
<!--        </el-col>-->
    </el-row>
  </div>
